...
class PlayersTeFodePage extends StatefulWidget {
  static const String routeName = '/playerstefode';

  @override
  _PlayersTeFodePage createState() => _PlayersTeFodePage();
}

class _PlayersTeFodePage extends State<PlayersTeFodePage> {
  ...
  void _twoPlayers() {
    Navigator.of(context).pushReplacementNamed(TeFodeTwoPage.routeName);
  }

  void _threePlayers() {
    Navigator.of(context).pushReplacementNamed(TeFodeThreePage.routeName);
  }

  void _fourPlayers() {
    Navigator.of(context).pushReplacementNamed(TeFodeFourPage.routeName);
  }

  void _fivePlayers() {
    Navigator.of(context).pushReplacementNamed(TeFodeFivePage.routeName);
  }

  void _sixPlayers() {
    Navigator.of(context).pushReplacementNamed(TeFodeSixPage.routeName);
  }
