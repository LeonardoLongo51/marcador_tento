...
class TeFodeSixPage extends StatefulWidget {
  static const String routeName = '/tefodesixpage';

  @override
  _TeFodeSixPage createState() => _TeFodeSixPage();
}

class _TeFodeSixPage extends State<TeFodeSixPage> {
  ...
  var _playerFive = Player(name: "Player 5", score: 5, victories: 0);
  var _playerSix = Player(name: "Player 6", score: 5, victories: 0);
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            _playerFour.name == '' && _name.text == ''
                                ...
                                : _name.text;
                            _playerFive.name == '' && _name.text == ''
                                ? player.name = "Player 5 "
                                : _name.text;
                            _playerSix.name == '' && _name.text == ''
  ...
  void _resetAll({bool resetVictories = true}) {
    ...
    _resetGame(player: _playerFive, resetVictories: resetVictories);
    _resetGame(player: _playerSix, resetVictories: resetVictories);
  }
  ...
  void _resetPlayers({bool resetVictories = true}) {
    ...
    _resetPlayer(player: _playerFive, resetVictories: resetVictories);
    _resetPlayer(player: _playerSix, resetVictories: resetVictories);
  }
  ...
  Widget _showPlayers3() {
    return Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.center,
      children: <Widget>[
        _showPlayerBoard(_playerFive),
        _showPlayerBoard(_playerSix),
      ],
    );
  }
        ...
        _buildRoundedButton(
          ...
          onTap: () {
            ...
            if (_playerFive.score != 0 &&
              ...
              _showDialog(
                  title: "Fim de Jogo!",
                  message: '${_playerFive.name} ganhou!',
                  confirm: () {
                    setState(() {
                      _playerFive.victories++;
                    });
                    _resetPlayers();
                  });
            }

            if (_playerSix.score != 0 &&
                _playerTwo.score == 0 &&
                _playerThree.score == 0 &&
                _playerFour.score == 0 &&
                _playerFive.score == 0 &&
              ...
              _showDialog(
                  title: "Fim de Jogo!",
                  message: '${_playerSix.name} ganhou!',
                  confirm: () {
                    setState(() {
                      _playerSix.victories++;
                    });
                    _resetPlayers();
                  });
            }
