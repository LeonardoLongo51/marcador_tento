...
class PlayersCaxetaPage extends StatefulWidget {
  static const String routeName = '/playerscaxeta';

  @override
  _PlayersCaxetaPage createState() => _PlayersCaxetaPage();
}

class _PlayersCaxetaPage extends State<PlayersCaxetaPage> {
