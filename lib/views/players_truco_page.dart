...
class PlayersTrucoPage extends StatefulWidget {
  static const String routeName = '/playerstruco';

  @override
  _PlayersTrucoPage createState() => _PlayersTrucoPage();
}

class _PlayersTrucoPage extends State<PlayersTrucoPage> {
...
*/
  ...
  void _twoPlayers() {
    Navigator.of(context).pushReplacementNamed(TrucoTwoPage.routeName);
  }
