...
class PlayersPresidentePage extends StatefulWidget {
  static const String routeName = '/playerspresidente';

  @override
  _PlayersPresidentePage createState() => _PlayersPresidentePage();
}

class _PlayersPresidentePage extends State<PlayersPresidentePage> {
